...
public class AutoCompleteTest {
  ...
  public static void init() {
    ...
    lexerAndParserFactory = new ReflectionLexerAndParserFactory(YattaLexer.class, YattaParser.class, (state) -> !Launcher.DISALLOWED_COMPLETION_STATES.contains(state));
  }
