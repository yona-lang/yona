 ...
 */
@TypeSystem({boolean.class, byte.class, long.class, double.class, String.class, Function.class, Unit.class, Tuple.class, Module.class, StringList.class, Sequence.class, Dictionary.class, Promise.class})
