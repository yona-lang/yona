...
public final class ModuleFunctionNode extends FunctionLikeNode {
  ...
  public ModuleFunctionNode(YonaLanguage language, SourceSection sourceSection, String moduleFQN, String name, int cardinality, FrameDescriptor frameDescriptor, ExpressionNode expression) {
