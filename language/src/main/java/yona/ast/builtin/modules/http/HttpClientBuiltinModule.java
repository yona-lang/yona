...
public final class HttpClientBuiltinModule implements BuiltinModule {
  ...
  abstract static class SendBuiltin extends BuiltinNode {
    @CompilerDirectives.TruffleBoundary
    protected Promise sendRequest(HttpSessionTuple sessionTuple, RequestType requestType, Seq uri, Dict headers, Seq body, @CachedContext(YonaLanguage.class) Context context, @CachedLibrary(limit = "3") InteropLibrary dispatch) {
  ...
  abstract static class GetBuiltin extends SendBuiltin {
    @Specialization
    public Promise get(HttpSessionTuple sessionTuple, Seq uri, Dict headers, @CachedContext(YonaLanguage.class) Context context, @CachedLibrary(limit = "3") InteropLibrary dispatch) {
  ...
  abstract static class DeleteBuiltin extends SendBuiltin {
    @Specialization
    public Promise delete(HttpSessionTuple sessionTuple, Seq uri, Dict headers, @CachedContext(YonaLanguage.class) Context context, @CachedLibrary(limit = "3") InteropLibrary dispatch) {
  ...
  abstract static class PostBuiltin extends SendBuiltin {
    @Specialization
    public Promise post(HttpSessionTuple sessionTuple, Seq uri, Dict headers, Seq body, @CachedContext(YonaLanguage.class) Context context, @CachedLibrary(limit = "3") InteropLibrary dispatch) {
  ...
  abstract static class PutBuiltin extends SendBuiltin {
    @Specialization
    public Promise put(HttpSessionTuple sessionTuple, Seq uri, Dict headers, Seq body, @CachedContext(YonaLanguage.class) Context context, @CachedLibrary(limit = "3") InteropLibrary dispatch) {
