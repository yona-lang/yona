...
/**
 * The node for function invocation in Yona. Since Yona has first class functions, the {@link Function
 ...
 * inline cache.
 */
@NodeInfo(shortName = "functionInvoke")
public final class FunctionInvokeNode extends InvokeNode {
  ...
  public FunctionInvokeNode(YonaLanguage language, Function function, ExpressionNode[] argumentNodes, ExpressionNode[] moduleStack) {
  ...
  public Object executeGeneric(VirtualFrame frame) {
    ...
    if (argumentNodes.length > function.getCardinality()) {
      ...
      return dispatchFunctionUnwrapArgs(function, function.isUnwrapArgumentPromises() && unwrapPromises, library, this, (Object[]) argumentValues);
    }
  }
  ...
  private Object createPartiallyAppliedClosure(Function function, VirtualFrame frame) {
     ...
     */
    InvokeNode invokeNode = new ExpressionInvokeNode(language, new IdentifierNode(language, function.getName(), moduleStack), allArgumentNodes, moduleStack);
     ...
     */
    WriteLocalVariableNode writeLocalVariableNode = WriteLocalVariableNodeGen.create(new AnyValueNode(function), frame.getFrameDescriptor().findOrAddFrameSlot(function.getName()));
