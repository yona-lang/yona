...
/**
 * Represents a Yona function. On the Truffle level, a callable element is represented by a
 * {@link RootCallTarget call target}. This class encapsulates a call target, and adds version
 * support: functions in Yona can be redefined, i.e. changed at run time. When a function is
...
public final class Function implements TruffleObject {
  ...
  abstract static class Execute {
     ...
     *
     * <p>
     * Since Yona is a quite simple language, the benefit of the inline cache seems small: after
     ...
     * target is usually much more complicated than in YonaLanguage.
     * </p>
     *
     * <p>
