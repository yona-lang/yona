...
public class SimpleExpressionTest {
  ...
  public void zeroArgFunctionTest() {
    long ret = context.eval("abzu", "\\ -> 5").execute().asLong();
    assertEquals(5l, ret);
  }

  @Test
  public void oneArgFunctionTest() {
    long ret = context.eval("abzu", "\\arg -> arg").execute(6).asLong();
    assertEquals(6l, ret);
  }

  @Test
  public void twoArgFunctionFirstTest() {
    long ret = context.eval("abzu", "\\argone argtwo -> argone").execute(5, 6).asLong();
    assertEquals(5l, ret);
  }

  @Test
  public void twoArgFunctionSecondTest() {
    long ret = context.eval("abzu", "\\argone argtwo -> argtwo").execute(5, 6).asLong();
    assertEquals(6l, ret);
  }
  ...
  public void letOneAliasTest() {
    long ret = context.eval("abzu", "\\test -> let alias = test in alias").execute(5).asLong();
    assertEquals(5l, ret);
  }

  @Test
  public void letTwoAliasesTest() {
    Value ret = context.eval("abzu", "\\test -> let \n" +
        "    alias = test\n" +
        "    aliastwo = 6\n" +
        "in\n" +
