...
public class PatternExpressionTest extends CommonTest {
  ...
  public void simpleTuplePatternTest() {
    long ret = context.eval(YonaLanguage.ID, "\\arg -> case arg of\n" +
        "(1, 2, 3) -> 6\n" +
        "(1, 2) -> 3\n"+
        "(2, 3) -> 5\n"+
        "_ -> 9\n" +
  ...
  public void boundVarPatternTest() {
    long ret = context.eval(YonaLanguage.ID, "\\arg bound -> case arg of\n" +
        "(1, 2, 3) -> 6\n" +
        "(1, bound) -> 1 + bound\n"+
        "(2, 3) -> 5\n"+
        "_ -> 9\n" +
  ...
  public void simpleStringPatternTest() {
    String ret = context.eval(YonaLanguage.ID, "\\arg -> case arg of\n" +
        "\"foo\" -> \"bar\"\n"+
        "\"hello\" -> \"world\"\n" +
        "_ -> \"unexpected\"\n" +
  ...
  public void headTailsFreeVarPatternTest() {
    Value sequence = context.eval(YonaLanguage.ID, "\\arg -> case arg of\n" +
        "1 -| [] -> 2\n" +
        "1 -| tail -> tail\n" +
        "[] -> 3\n"+
        "_ -> 9\n" +
  ...
  public void headTailsBoundVarPatternTest() {
    Value sequence = context.eval(YonaLanguage.ID, "\\arg bound -> case arg of\n" +
        "1 -| [] -> 2\n" +
        "1 -| bound -> bound\n" +
        "[] -> 3\n"+
        "_ -> 9\n" +
  ...
  public void tupleInLetPatternTest() {
    long ret = context.eval(YonaLanguage.ID, "let (1, x, _) = (1, 2, 3) in x").asLong();
  ...
  public void sequenceInLetPatternTest() {
    long ret = context.eval(YonaLanguage.ID, "let [1, x, y] = [1, 2, 3] in x + y").asLong();
  ...
  public void guardsInCaseInLambdaTest() {
    String ret = context.eval(YonaLanguage.ID, "\\arg -> case () of\n" +
        "_ | arg < 0     -> \"negative\"\n" +
        "  | arg == 0    -> \"zero\"\n" +
        "  | true        -> \"positive\"\n" +
        "end\n").execute(0l).asString();
  ...
  public void nestedCaseSyntaxTest() {
    long ret = context.eval(YonaLanguage.ID, "case [1, 2, 3] of\n" +
        "[1, 2] -> 0\n" +
  ...
  public void stringPrefixTest() {
    long ret = context.eval(YonaLanguage.ID, "case ['a', 'b', 'c'] of\n" +
        "\"ab\" |- _ -> 0\n" +
        "_ -> 1\n" +
        "end").asLong();
  ...
  public void stringPrefixAndSuffixTest() {
    long ret = context.eval(YonaLanguage.ID, "case \"hello there\" of\n" +
        "'h' -| 'e' -| _ |- 'r' |- 'e' -> 0\n" +
        "_ -> 1\n" +
        "end").asLong();
  ...
  public void recordTest() {
    long ret = context.eval(YonaLanguage.ID, "let mod = module TestMod exports testfun as\n" +
