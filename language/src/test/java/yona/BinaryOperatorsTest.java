...
public class BinaryOperatorsTest extends CommonTest {
  ...
  void testEqualsOps(BinaryArgsHolder args) {
    Object ret = context.eval(YonaLanguage.ID, args.format("==")).as(args.expectedType);
  ...
  void testNotEqualsOps(BinaryArgsHolder args) {
    ...
    Object ret = context.eval(YonaLanguage.ID, newArgs.format("!=")).as(newArgs.expectedType);
  ...
  void testPowerOps(BinaryArgsHolder args) {
    Object ret = context.eval(YonaLanguage.ID, args.format("**")).asDouble();
    assertEquals(args.expected, ret);
  }
  ...
  public void testOperatorPrecedence(String expression, String expected) {
    assertEquals(expected, context.eval(YonaLanguage.ID, expression).toString());
  }
  ...
  void testSequenceCatenateOps(BinaryArgsHolder args) {
    Value ret = context.eval(YonaLanguage.ID, args.format("++"));
  ...
  void testSequenceJoinLeftOps(BinaryArgsHolder args) {
    Object[] ret = context.eval(YonaLanguage.ID, args.format("-|")).as(Object[].class);
  ...
  void testInOps(BinaryArgsHolder args) {
    boolean ret = context.eval(YonaLanguage.ID, args.format("in")).asBoolean();
    assertEquals(args.expected, ret);
  }
