	...
	if(YONA_LLD_INCLUDE_DIR)
		if(WIN32)
			...
			if(YONA_LLD_COMMON_LIB AND YONA_LLD_COFF_LIB)
				...
				set(YONA_INPROCESS_LLD_LIBS ${YONA_LLD_COFF_LIB} ${YONA_LLD_COMMON_LIB})
		...
		elseif(APPLE)
			...
			if(YONA_LLD_COMMON_LIB AND YONA_LLD_MACHO_LIB)
				set(YONA_INPROCESS_LLD_AVAILABLE ON)
				set(YONA_INPROCESS_LLD_LIBS ${YONA_LLD_MACHO_LIB} ${YONA_LLD_COMMON_LIB})
		...
		elseif(UNIX)
			...
			if(YONA_LLD_COMMON_LIB AND YONA_LLD_ELF_LIB)
				set(YONA_INPROCESS_LLD_AVAILABLE ON)
				set(YONA_INPROCESS_LLD_LIBS ${YONA_LLD_ELF_LIB} ${YONA_LLD_COMMON_LIB})
