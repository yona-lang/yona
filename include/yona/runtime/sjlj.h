 ...
 * slot 2 = SP, slots 3–4 reserved. yona_rt_raise longjmps into the same
...
#ifndef YONA_RUNTIME_SJLJ_H
#define YONA_RUNTIME_SJLJ_H

#if defined(__aarch64__)

#define yona_sjlj_setjmp(buf) \
	__extension__({ \
		int _yona_sj; \
		void** _yona_b = (void**)(buf); \
		__asm__ volatile( \
			"str x29, [%1]\n\t" \
			"adr x2, 1f\n\t" \
			"str x2, [%1, #8]\n\t" \
