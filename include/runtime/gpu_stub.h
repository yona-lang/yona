...
/// Without CMake Vulkan on Unix, probes return zeros / false.
...
/* Yona `extern native floatArrayMul2Async : FloatArray -> Int` — in-place mul2 on GPU
 * when available; promise completes with 0 on success or a negative error code. */
 ...
 * doubles (Yona layout); each element is multiplied by 2 on the GPU and written
